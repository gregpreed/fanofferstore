...
class WC_Stamps_Labels {
	...
	public static function create_label( $order, $label_result ) {
		...
		$label['post_parent']   = $order->id;
		$label['post_title']    = $label_result->TrackingNumber;
		$label['post_content']  = $label_result->URL;
