			...
			<tbody><?php
				...
				foreach ( $labels as $label ) :
					...
					?><tr class='<?php echo $alt; ?>'>
						...
						<td>
							<strong>
								<a href='<?php echo get_edit_post_link( $label->ID ); ?>' class='row-title' title='<?php _e( 'Edit Label', 'woocommerce-advanced-product-labels' ); ?>'>
									<?php echo $label->post_title; echo empty( $label->post_title) ? __( 'Untitled', 'woocommerce-advanced-product-labels' ) : null; ?>
								</a>
							</strong>
							<div class='row-actions'>
								<span class='edit'>
									<a href='<?php echo get_edit_post_link( $label->ID ); ?>' title='<?php _e( 'Edit Label', 'woocommerce-advanced-product-labels' ); ?>'>
										<?php _e( 'Edit', 'woocommerce-advanced-product-labels' ); ?>
									</a>
									 |
								</span>
								<span class='trash'>
									<a href='<?php echo get_delete_post_link( $label->ID ); ?>' title='<?php _e( 'Delete Label', 'woocommerce-advanced-product-labels' ); ?>'>
										<?php _e( 'Delete', 'woocommerce-advanced-product-labels' ); ?>
									</a>
								</span>
							</div>
						</td>
