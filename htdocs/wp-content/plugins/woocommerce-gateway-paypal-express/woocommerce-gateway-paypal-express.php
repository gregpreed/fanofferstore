...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '4.0.0', __( 'WooCommerce PayPal Express Gateway', 'woocommerce-gateway-paypal-express' ), __FILE__, 'init_woocommerce_gateway_paypal_express', array( 'is_payment_gateway' => true, 'minimum_wc_version' => '2.2', 'backwards_compatible' => '4.0.0' ) );
