	...
	class WC_Settings_Prdctfltr {
		...
		public static function prdctfltr_admin_scripts($hook) {
			...
			if ( isset( $_GET['page'], $_GET['tab'] ) && ($_GET['page'] == 'wc-settings' || $_GET['page'] == 'woocommerce_settings' ) && $_GET['tab'] == 'settings_products_filter' ) {
				wp_register_style( 'prdctfltr-admin', WC_Prdctfltr::$url_path .'lib/css/admin.css', false, '4.1.0' );
				wp_enqueue_style( 'prdctfltr-admin' );
				wp_register_script( 'prdctfltr-settings', WC_Prdctfltr::$url_path . 'lib/js/admin.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-sortable' ), '4.1.0', true );
			...
			<?php
				...
				$settings = array(
					'section_basic_title' => array(
						...
						'type'     => 'title',
						'desc'     => __( 'Setup Product Filter appearance and basic settings.', 'prdctfltr' ),
					...
					'section_style_title' => array(
						...
						'type'     => 'title',
						'desc'     => __( 'Setup Product Filter style settings.', 'prdctfltr' ),
					...
					'section_title' => array(
						...
						'type'     => 'title',
						'desc'     => __( 'Select filters to use. Add basic, advanced filters or ranges.', 'prdctfltr' ),
