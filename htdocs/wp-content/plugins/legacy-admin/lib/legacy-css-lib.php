...
function legacy_css_bgcolor($selector, $id, $opacity = "", $valuetype = "") {
    global $legacyadmin;
    if ($valuetype == "string") {
        $value = $id;
...
function legacy_css_background($selector, $id, $opacity = "", $type = "") {
    global $legacyadmin;
    if ($type == "array") {
        $value = $id;
    } else {
    ...
    if (isset($legacyadminID) && trim($legacyadminID) != "") {
        $bg_image = "background-image:url(" . $legacyadminID . "); ";
    }

    $bg_color = "";
    $legacyadminID = $value['background-color'];
    $colorcode = legacy_colorcode($legacyadminID, $opacity);
    $bg_color = "background-color: " . $colorcode . ";";

    $bg_repeat = "";
    $legacyadminID = $value['background-repeat'];
    if (isset($legacyadminID) && trim($legacyadminID) != "") {
        $bg_repeat = "background-repeat:" . $legacyadminID . "; ";
    }

    $bg_size = "";
    $legacyadminID = $value['background-size'];
    if (isset($legacyadminID) && trim($legacyadminID) != "") {
        $bg_size = "-webkit-background-size:" . $legacyadminID . "; "
                . "-moz-background-size:" . $legacyadminID . "; "
                . "-o-background-size:" . $legacyadminID . "; "
                . "background-size:" . $legacyadminID . "; ";
    }

    $bg_attach = "";
    $legacyadminID = $value['background-attachment'];
    if (isset($legacyadminID) && trim($legacyadminID) != "") {
        $bg_attach = "background-attachment:" . $legacyadminID . "; ";
    }

    $bg_pos = "";
    $legacyadminID = $value['background-position'];
    if (isset($legacyadminID) && trim($legacyadminID) != "") {
        $bg_pos = "background-position:" . $legacyadminID . "; ";
    }
