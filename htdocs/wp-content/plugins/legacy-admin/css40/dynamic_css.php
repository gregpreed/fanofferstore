...
echo " \n/* -- Heading -- */\n";
$legacystr = " h1,h2,h3,h4,h5,h6, .wrap h2 , .welcome-panel .about-description";
...
echo " \n/* -- Box Head -- */\n";
$legacystr = " .postbox .hndle, .stuffbox .hndle, .welcome-panel h3, .settings_page_menu_editor .ui-dialog-titlebar";
