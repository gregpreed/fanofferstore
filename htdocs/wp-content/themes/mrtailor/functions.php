...
function mr_tailor_scripts()
{
    ...
    if (file_exists(dirname(__FILE__) . '/js/_combined.min.js')) {
        ...
        wp_enqueue_script('mr_tailor-combined-scripts', get_template_directory_uri() . '/js/_combined.min.js', array(
            'jquery'
        ), '1.0', TRUE);
        
    } else {
        
        wp_enqueue_script('mr_tailor-foundation', get_template_directory_uri() . '/js/foundation.min.js', array(
            'jquery'
        ), '5.2.0', TRUE);
        wp_enqueue_script('mr_tailor-foundation-interchange', get_template_directory_uri() . '/js/foundation.interchange.js', array(
            'jquery'
        ), '5.2.0', TRUE);
        wp_enqueue_script('mr_tailor-isotope', get_template_directory_uri() . '/js/isotope.pkgd.min.js', array(
            'jquery'
        ), 'v2.0.0', TRUE);
        wp_enqueue_script('mr_tailor-imagesloaded', get_template_directory_uri() . '/js/imagesloaded.js', array(
            'jquery'
        ), 'v3.1.4', TRUE);
        wp_enqueue_script('mr_tailor-touchswipe', get_template_directory_uri() . '/js/jquery.touchSwipe.min.js', array(
            'jquery'
        ), '1.6.5', TRUE);
        wp_enqueue_script('mr_tailor-fitvids', get_template_directory_uri() . '/js/jquery.fitvids.js', array(
            'jquery'
        ), '1.0.3', TRUE);
        wp_enqueue_script('mr_tailor-idangerous-swiper', get_template_directory_uri() . '/js/idangerous.swiper.min.js', array(
            'jquery'
        ), '2.6.1', TRUE);
        wp_enqueue_script('mr_tailor-owl', get_template_directory_uri() . '/js/owl.carousel.min.js', array(
            'jquery'
        ), '1.3.1', TRUE);
        wp_enqueue_script('mr_tailor-fresco', get_template_directory_uri() . '/js/fresco.js', array(
            'jquery'
        ), '1.3.0', TRUE);
        wp_enqueue_script('mr_tailor-nanoscroller', get_template_directory_uri() . '/js/jquery.nanoscroller.min.js', array(
            'jquery'
        ), '0.7.6', TRUE);
        wp_enqueue_script('mr_tailor-select2', get_template_directory_uri() . '/js/select2.min.js', array(
            'jquery'
        ), '3.5.1', TRUE);
        wp_enqueue_script('mr_tailor-scroll_to', get_template_directory_uri() . '/js/jquery.scroll_to.js', array(
            'jquery'
        ), '1.4.5', TRUE);
        wp_enqueue_script('mr_tailor-stellar', get_template_directory_uri() . '/js/jquery.stellar.min.js', array(
            'jquery'
        ), '0.6.2', TRUE);
        wp_enqueue_script('mr_tailor-snapscroll', get_template_directory_uri() . '/js/jquery.snapscroll.min.js', array(
            'jquery'
        ), '1.6.1', TRUE);
        wp_enqueue_script('mr_tailor-easyzoom', get_template_directory_uri() . '/js/easyzoom.js', array(
            'jquery'
        ), '1.0', TRUE);
        wp_enqueue_script('mr_tailor-scripts', get_template_directory_uri() . '/js/scripts.js', array(
            'jquery'
        ), '1.0', TRUE);
    ...
    if (isset($mr_tailor_theme_options['out_of_stock_text'])) {
        ...
        function custom_get_availability($availability, $_product)
        {
            ...
            if (!$_product->is_in_stock())
                $availability['availability'] = __($mr_tailor_theme_options['out_of_stock_text'], 'mr_tailor');
            return $availability;
        }
    }
...
function newIconFont()
{
    ...
    wp_register_style('redux-font-awesome', get_template_directory_uri() . '/inc/fonts/font-awesome/css/font-awesome.min.css', array(), time(), 'all');
...
?>
        ...
        <span class="shopping_bag_items_number"><?php
        echo $woocommerce->cart->cart_contents_count;
?></span>
...
?>
    ...
    <div class="box-share-master-container">
        <div class="box-share-container product-share-container">
            ...
            <a class="trigger-share-list" href="#"><i class="fa fa-share-alt"></i><?php
        _e('Share this product', 'mr_tailor');
?></a>
...
?>
                ...
                <div class="box-share-list-inner">
                    <a href="//www.facebook.com/sharer.php?u=<?php
        the_permalink();
?>" class="box-share-link" target="_blank"><i class="fa fa-facebook"></i><span>Facebook</span></a>
                    <a href="//twitter.com/share?url=<?php
        the_permalink();
?>" class="box-share-link" target="_blank"><i class="fa fa-twitter"></i><span>Twitter</span></a>
                    <a href="//plus.google.com/share?url=<?php
        the_permalink();
?>" class="box-share-link" target="_blank"><i class="fa fa-google-plus"></i><span>Google</span></a>
...
?>" class="box-share-link" target="_blank"><i class="fa fa-pinterest"></i><span>Pinterest</span></a>
...
add_action('woocommerce_checkout_order_processed', 'printio');
//add_action ('woocommerce_thankyou', 'printio');



function printio($order_id)
{
    ...
    foreach ($order->get_items() as $item) {
        ...
        if ($product->get_attribute('printio')) {
            $printioList[] = array(
 ...
 if (count($printioList) > 0) {
        $data = array(
            ...
            'Payment' => array(
			  ...
			  //Live
			  "PartnerBillingKey"=> "/Nzltq417Yl8Ync5HDg9BavUSfbOzSd0O55UWYUVtFA="
        ...
        //staging 
	    //$ch = curl_init('http://staging.api.print.io/api/v/1/source/api/orders/?recipeid=3978dc7f-db69-49bd-b461-63f58ed0ed48');
	    //live
	    $ch = curl_init('https://api.print.io/api/v/1/source/api/orders/?recipeid=242519df-4a3f-4024-93d5-da623a753221'); 
